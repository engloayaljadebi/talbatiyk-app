...
import 'package:talbatiyk_api/src/serializers.dart';
import 'package:talbatiyk_api/src/auth/api_key_auth.dart';
import 'package:talbatiyk_api/src/auth/basic_auth.dart';
import 'package:talbatiyk_api/src/auth/bearer_auth.dart';
import 'package:talbatiyk_api/src/auth/oauth.dart';
import 'package:talbatiyk_api/src/api/auth_api.dart';
...
class TalbatiykApi {
  ...
  /// Get BusinessContactApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  BusinessContactApi getBusinessContactApi() {
    return BusinessContactApi(dio, serializers);
  }

  /// Get BusinessLocationApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
