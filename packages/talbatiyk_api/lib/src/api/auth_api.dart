...
class AuthApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AuthRegister201Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthRegister201Response>> authLogin({ 
    ...
    AuthRegister201Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AuthRegister201Response),
      ) as AuthRegister201Response;
    ...
    return Response<AuthRegister201Response>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [AuthRegister201Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthRegister201Response>> authRegister({ 
  ...
  /// Returns a [Future] containing a [Response] with a [AuthMe200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthMe200Response>> authUpdateProfile({ 
