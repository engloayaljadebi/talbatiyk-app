...
class OrderApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [OrderIndex200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OrderIndex200Response>> orderIndex({ 
    ...
    OrderIndex200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(OrderIndex200Response),
      ) as OrderIndex200Response;
    ...
    return Response<OrderIndex200Response>(
      data: _responseData,
